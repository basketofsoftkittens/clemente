...
class CNN(object):
    ...
    def build(self):
        ...
        conv1 = (Conv2D(16, (3, 3), strides=(1, 1),
                        activation='elu', padding='same'))(re_input)
        conv1 = (Conv2D(16, (3, 3), strides=(1, 1),
                        activation='elu', padding='same'))(conv1)
        ...
        conv2 = (Conv2D(32, (3, 3), strides=(1, 1),
                        activation='elu', padding='same'))(conv1)
        conv2 = (Conv2D(32, (3, 3), strides=(1, 1),
                        activation='elu', padding='same'))(conv2)
        ...
        conv3 = (Conv2D(64, (3, 3), strides=(1, 1),
                        activation='elu', padding='same'))(conv2)
        conv3 = (Conv2D(64, (3, 3), strides=(1, 1),
                        activation='elu', padding='same'))(conv3)
        ...
        conv4 = (Conv2D(128, (3, 3), strides=(1, 1),
                        activation='elu', padding='same'))(conv3)
        conv4 = (Conv2D(128, (3, 3), strides=(1, 1),
                        activation='elu', padding='same'))(conv4)
        conv4 = (Conv2D(128, (3, 3), strides=(1, 3),
                        activation='elu', padding='same'))(conv4)

        # DNN
        flatten = TimeDistributed(layers.Flatten())(conv4)
        dense1 = TimeDistributed(Dense(64, activation='elu'))(flatten)
        ...
        model: keras.Model = Model(
            outputs=[average_score, frame_score],
            inputs=_input,
         )
